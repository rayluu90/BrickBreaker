 ...
 * DrawSpriteOnce.cs
 * 
 * Draw the sprite only once instead of continuously draw the same sprite
*/
namespace BrickBreaker
{
    abstract class DrawSpriteOnce
    {
        ...
        // Defaul constructor
        public DrawSpriteOnce(Texture2D textureImage, Vector2 position, Point frameSize, int collisionOffset,
            ...
            : this(textureImage, position, frameSize, collisionOffset,
                currentFrame, sheetSize, speed, defaultMillisecondsPerframe, collisionCueName)
        {}

        // overloaded constructor
        public DrawSpriteOnce(Texture2D textureImage, Vector2 position, Point frameSize, int collisionOffset,
            Point currentFrame, Point sheetSize, Vector2 speed, int millisecondPerFrame, string collisionCueName)
        {
